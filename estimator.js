...
function openEstimatorModule() {
  ...
  ['purch-module-wrap', 'curt-module-wrap', 'sk-module-wrap', 'sales-module-wrap', 'approver-module-wrap', 'jobs-module-wrap', 'accounts-module-wrap', 'hr-module-wrap', 'joinery-module-wrap', 'upholstery-module-wrap', 'painting-module-wrap', 'owner-module-wrap', 'fleet-module-wrap', 'delivery-sched-module-wrap', 'admin-module-wrap'].forEach(id => {
      ...
      (k.pendingToPickList.length === 0 ? `<p style="font-size:12px;color:#64748b;">Nothing pending.</p>` :
        k.pendingToPickList.map(q => {
          ...
          return `<div style="display:flex;justify-content:space-between;align-items:center;padding:8px 0;border-bottom:1px solid #f1f5f9;">
            <div><p style="font-weight:700;font-size:12.5px;">${q.id} ${quoteAgeBadge(q)}</p><p style="font-size:11px;color:#64748b;">${eEsc(s.client)} · ${eEsc(q.projectName)} · ${eEsc(s.salesman)}</p></div>
