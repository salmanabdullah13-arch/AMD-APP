...
|---|---|---|---|---|---|---|---|---|
| Operations | owner | ✓ | ✓ | ✓ | ✓ | n/a | 3 | `operations-desktop-light.png` `operations-desktop-dark.png` `operations-phone-light.png` `operations-phone-dark.png` |
| Curtain & Blinds | owner | ✓ | ✓ | ✓ | ✓ | n/a | 1 | `curtain-blinds-desktop-light.png` `curtain-blinds-desktop-dark.png` `curtain-blinds-phone-light.png` `curtain-blinds-phone-dark.png` |
| Purchaser | owner | ✓ | ✓ | ✓ | ✓ | n/a | 0 | `purchaser-desktop-light.png` `purchaser-desktop-dark.png` `purchaser-phone-light.png` `purchaser-phone-dark.png` |
| Storekeeper | owner | ✓ | ✓ | ✓ | ✓ | n/a | 0 | `storekeeper-desktop-light.png` `storekeeper-desktop-dark.png` `storekeeper-phone-light.png` `storekeeper-phone-dark.png` |
| Upholstery | owner | ✓ | ✓ | ✓ | ✓ | n/a | 4 | `upholstery-desktop-light.png` `upholstery-desktop-dark.png` `upholstery-phone-light.png` `upholstery-phone-dark.png` |
| Sales | owner | ✓ | ✓ | ✓ | ✓ | n/a | 3 | `sales-desktop-light.png` `sales-desktop-dark.png` `sales-phone-light.png` `sales-phone-dark.png` |
| Estimator | owner | ✓ | ✓ | ✓ | ✓ | n/a | 3 | `estimator-desktop-light.png` `estimator-desktop-dark.png` `estimator-phone-light.png` `estimator-phone-dark.png` |
| Owner Dashboard | owner | ✓ | ✓ | ✓ | ✓ | n/a | 4 | `owner-dashboard-desktop-light.png` `owner-dashboard-desktop-dark.png` `owner-dashboard-phone-light.png` `owner-dashboard-phone-dark.png` |
| Admin Dashboard | owner | ✓ | ✓ | ✓ | ✓ | n/a | 0 | `admin-dashboard-desktop-light.png` `admin-dashboard-desktop-dark.png` `admin-dashboard-phone-light.png` `admin-dashboard-phone-dark.png` |
| Production | owner | ✓ | ✓ | ✓ | ✓ | n/a | 3 | `production-desktop-light.png` `production-desktop-dark.png` `production-phone-light.png` `production-phone-dark.png` |
| Crew clock | owner | ✓ | ✓ | ✓ | ✓ | n/a | 0 | `crew-clock-desktop-light.png` `crew-clock-desktop-dark.png` `crew-clock-phone-light.png` `crew-clock-phone-dark.png` |
| Accounts | owner | ✓ | ✓ | ✓ | ✓ | n/a | 0 | `accounts-desktop-light.png` `accounts-desktop-dark.png` `accounts-phone-light.png` `accounts-phone-dark.png` |
...
| Delivery / Scheduling | owner | ✓ | ✓ | ✓ | ✓ | n/a | 0 | `delivery-scheduling-desktop-light.png` `delivery-scheduling-desktop-dark.png` `delivery-scheduling-phone-light.png` `delivery-scheduling-phone-dark.png` |
| Production — Painting Lead | painting_lead | ✓ | ✓ | ✓ | ✓ | ✓ | 1 | `production-painting-lead-desktop-light.png` `production-painting-lead-desktop-dark.png` `production-painting-lead-phone-light.png` `production-painting-lead-phone-dark.png` |
| Production — Draftsman | joinery_draftsman | ✓ | ✓ | ✓ | ✓ | ✓ | 1 | `production-draftsman-desktop-light.png` `production-draftsman-desktop-dark.png` `production-draftsman-phone-light.png` `production-draftsman-phone-dark.png` |
| Production — Team Leader | joinery_team_leader | ✓ | ✓ | ✓ | ✓ | ✓ | 5 | `production-team-leader-desktop-light.png` `production-team-leader-desktop-dark.png` `production-team-leader-phone-light.png` `production-team-leader-phone-dark.png` |
