...
const CACHE_VERSION = "amd-app-v75"; // v75: the rest of the documents — invoice, delivery note, PO, vouchers, SOA, report prints
const CORE_ASSETS = [
  ...
  "./data.js", "./purchase-item-gate.js", "./purchase-data.js", "./purchase-ui.js", "./store-data.js", "./production-data.js", "./production-ui.js", "./chart-widgets.js", "./planner-tasks.js", "./ops-dashboard.js", "./auth.js", "./approval-queue.js", "./print.js", "./print-documents.js", "./teamcomms.js", "./shell.js",
